#n=number of isolates to array
#evenWellAssays=T or F if the ultimate bioassays should have even allocation of wells  (e.g., for flow, biomass, RNA extraction) - for future use, not useful for assays that  now
...
for (i in 1:length(u)){
  ...
  assayset=c(rep(c("RNA", "Biomass","FlowCyto."),((no.wells*n)/3)))
